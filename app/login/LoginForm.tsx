    ...
    <div className="container-page py-20 max-w-md">
      ...
      <form onSubmit={submit} className="card-paper space-y-4">
        <label className="block">
          <span className="block text-xs font-medium uppercase tracking-tight text-gris-700 mb-1">
            Email
          </span>
          <input
            type="email"
            ...
            className="w-full px-3 py-2 border border-gris-200 rounded-lg bg-white"
          />
        </label>
        <label className="block">
          <span className="block text-xs font-medium uppercase tracking-tight text-gris-700 mb-1">
        ...
        {error && <p className="text-jaune text-sm">{error}</p>}
